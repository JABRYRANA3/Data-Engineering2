"""
Generate a synthetic esports text corpus for DE2 Lab 2 - Track A.
Produces a single CSV file: data/corpus/esports_corpus.csv
with ~150 documents (hero lore + patch notes + match commentary).
"""
